...
Laplace operator \ref{} to the threshold image.

\item {\bf Line detection (Hough transform)}

To identify lines of the image border
in the edge image, a linear Hough transform \ref{} is used. Lines are described
...
\begin{thebibliography}{}
  ...
  \bibitem{hough} Use of the Hough transformation to detect lines and curves in pictures.
