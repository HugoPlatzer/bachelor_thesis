...
The version of SANE / pieusb used here is {\bf 1.0.25-4.1}, as is part of
Debian 9 (Stretch).

\subsubsection{Fixing I/O errors}

For my device, scanning unfortunately did not work as-is. When
...
\subsection{Local pixelwise operations}

\subsubsection{Color negative film}
