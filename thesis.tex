...
\begin{figure}[H]
  \centering
  (a) \includegraphics[width=5cm]{images/inpaint_1.jpg} \hspace{0.5cm}
  (b) \includegraphics[width=5cm]{images/inpaint_2.jpg}
...
\begin{figure}[H]
  \centering
  (a) \includegraphics[width=4cm]{images/inpaint_4a.jpg} \hspace{0.5cm}
  (b) \includegraphics[width=4cm]{images/inpaint_4b.jpg} \hspace{0.5cm} \\
  (c) \includegraphics[width=4cm]{images/inpaint_4c.jpg}
...
not just the described RGBI order. The order is chosen based 

\item
The scanner has a maximum advertised resolution of 7200 dpi. The maximum line width
however is 5341 px, giving a horizontal resolution of only
