...
and endpoint plus an extra 8 bytes of data called the Device Request.

\begin{table}[H]
  \caption{Device Request format}
  \centering
...
\begin{table}[H]
  \caption{Some important Standard Requests}
  \centering
...
This is seen in \cite[p. 23]{usbstd}
