...
\begin{figure}[H]
  \centering
  \includegraphics[width=12cm]{images/extract_calib2.jpg}
  \caption{Calibration image, chosen width: 21364 pixels}
\end{figure}

The calibration image has the same channel interleaving pattern as the regular one,
so we extract the different channels using different line offsets.
This means the line width of each channel
is 1/4, so 5341 pixels.
