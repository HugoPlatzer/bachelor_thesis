...
\begin{figure}[H]
    \centering
    \subfloat[before calibration]{{\includegraphics[width=0.4\textwidth]{images/calib_a.jpg} }}
    \subfloat[calibration image]{{\includegraphics[width=0.4\textwidth]{images/calib_b.jpg} }}
    
    \subfloat[division $a / b$]{{\includegraphics[width=0.4\textwidth]{images/calib_c.jpg} }}
...
\begin{figure}[H]
  \centering
  (a) \includegraphics[width=0.4\textwidth]{images/imgop_color1.jpg} \hspace{0.5cm}
  (b) \includegraphics[width=0.4\textwidth]{images/imgop_color2.jpg}
  
  (c) \includegraphics[width=0.4\textwidth]{images/imgop_color_h.jpg} \hspace{0.5cm}
  (d) \includegraphics[width=0.4\textwidth]{images/imgop_color3.jpg}
...
\begin{figure}[H]
  \centering
  (a) \includegraphics[width=0.4\textwidth]{images/inpaint_1.jpg} \hspace{0.5cm}
  (b) \includegraphics[width=0.4\textwidth]{images/inpaint_2.jpg}
  \caption{(a) Crop of slide film scan affected by dust. (b) Infrared channel}
\end{figure}
...
film types, but they may over/underreact on images with unusually large / small amounts
of dust.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=6cm]{images/inpaint_3.jpg}
...
\begin{figure}[H]
  \centering
  (a) \includegraphics[width=0.4\textwidth]{images/inpaint_4a.jpg} \hspace{0.5cm}
  (b) \includegraphics[width=0.4\textwidth]{images/inpaint_4b.jpg} \hspace{0.5cm}
  
  (c) \includegraphics[width=0.4\textwidth]{images/inpaint_4c.jpg}
  \caption{(a) Image after doing diffusion for (a) 1 iteration, (b) 10 iterations, (c)100 iterations}
\end{figure}
...
%\subsubsection{Image transaction}
%\label{appendix_image}
