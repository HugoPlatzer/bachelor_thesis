...
$\frac{\textrm{0x2928} - \textrm{0x026f}}{\textrm{0x19f8} - \textrm{0x000f}} = \frac{9913}{6633} = 1.494$.
...
(see \ref{p:imageparam_query}). This is multiplied by the number of lines $l$ to be transferred
