...
\begin{figure}[H]
  ...
  \centering
  \scalebox{1}{\input{images_new/tikz/usb_composition.tex}}
\end{figure}
...
\begin{figure}[H]
  ...
  \centering
  \resizebox{\textwidth}{!}{\input{images_new/tikz/sane_hierarchy.tex}}
...
\begin{figure}[H]
  ...
  \centering
  \scalebox{1}{\input{images_new/tikz/sane_codeflow.tex}}
  \label{sane_codeflow}
\end{figure}
