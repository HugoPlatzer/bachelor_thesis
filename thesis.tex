...
Dust and scratches are an undesired artifact of scanning film material. Depending
...
To deal with this, a technique often called Digital ICE was developed. It involves
...
that can claim to be the best in all scenarios.

The possibly simplest inpainting algorithm that gives decent results is called
diffusion. Its idea is to let image information flow from the edges of the mask
