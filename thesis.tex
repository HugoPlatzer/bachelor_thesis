...
\begin{figure}[H]
  \caption{Wireshark main screen: Choose an interface and start capturing or load an existing capture.}
  \centering
  \includegraphics[width=0.9\textwidth]{images/wireshark_main.jpg}
\end{figure}

\begin{figure}[H]
  \caption{Wireshark analysis screen: Packets are shown as a list in the center, sorted by some column.
           Details for the selected packet can be inspected below. On the bottom, it shows the raw packet bytes.}
  \centering
  \includegraphics[width=0.9\textwidth]{images/wireshark_analyze.jpg}
\end{figure}
...
\begin{figure}[H]
    \centering
    \subfloat[width 1655]{{\includegraphics[width=2cm]{images/extract_result1.jpg} }}
    \qquad
    \subfloat[every 2nd byte, width 1655]{{\includegraphics[width=4cm]{images/extract_result2.jpg} }}
    \qquad
    \subfloat[every 2nd byte, width 1653]{{\includegraphics[width=4cm]{images/extract_result3.jpg} }}
...
\begin{figure}[H]
    \centering
    \subfloat[offset 0]{{\includegraphics[width=3.5cm]{images/extract_result3.jpg} }}
    \quad
    \subfloat[offset 766]{{\includegraphics[width=3.5cm]{images/extract_result5.jpg} }}
    \quad
    \subfloat[offset 1300]{{\includegraphics[width=3.5cm]{images/extract_result4.jpg} }}
...
\begin{figure}[H]
    \centering
    \subfloat[every 3rd line, offset 0]{{\includegraphics[width=5.5cm]{images/extract_result6.jpg} }}
    \quad
    \subfloat[every 3rd line, offset 1]{{\includegraphics[width=5.5cm]{images/extract_result7.jpg} }}
    \quad
    \subfloat[every 3rd line, offset 2]{{\includegraphics[width=5.5cm]{images/extract_result8.jpg} }}
