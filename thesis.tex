...
\begin{figure}[H]
  \centering
  \includegraphics[width=6cm]{images/crop_1.jpg}
  \caption{Full-area scan and suitable crop frame (in blue)}
\end{figure}
...
\begin{enumerate}
\item {\bf Grayscale conversion} This gets us from three to one channel to simplify
operations. It can be done by simply averaging the red, green, blue values at
each pixel.

\item {\bf Histogram equalization}
