...
\begin{figure}[H]
  ...
  \centering
  \scalebox{2}{\input{images_new/tikz/usb_cable.tex}}
\end{figure}
...
\begin{figure}[H]
  ...
  \centering
  \scalebox{0.35}{\input{images_new/tikz/usb_nrzi.tex}}
\end{figure}
...
\begin{figure}[H]
  ...
  \centering
  \scalebox{1}{\input{images_new/tikz/usb_tokenpacket.tex}}
\end{figure}
...
\begin{figure}[H]
  ...
  \centering
  \scalebox{1}{\input{images_new/tikz/usb_datapacket.tex}}
\end{figure}
...
\begin{figure}[H]
  ...
  \centering
  \scalebox{1}{\input{images_new/tikz/usb_handshakepacket.tex}}
\end{figure}
